...
def _add_automount_home_map_entries(
    olc_suffix: str, homedir_server_ipaddr: str
) -> None:
...
def _ldap(
    cmd: Literal["add", "modify"], olc_suffix: str, admin_password: str, ldif: str
) -> None:
    """Add or modify an ldap mapping."""
    try:
...
def _non_interactive_config_for_slapd(
    admin_password, domain, organization_name
) -> None:
...
class OpenLDAPOps:
    ...
    def configure_automount_maps(
        self, olc_suffix: str, homedir_server_ipaddr: str
    ) -> None:
